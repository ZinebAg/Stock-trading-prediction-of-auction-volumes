...
Original file is located at
    https://colab.research.google.com/drive/1xJSLCNCxQsC8niJClluxqvExDHAnjEAN
"""
...
# test_predict_RF_KNN_Ridge = model_1.predict(test_data_RF_KNN)

# RF_KNN_Ridge=submission_file_template.copy()
# RF_KNN_Ridge.target=test_predict_RF_KNN_Ridge

# RF_KNN_Ridge=RF_KNN_Ridge.set_index('ID')
# RF_KNN_Ridge.to_csv("/content/drive/MyDrive/Master Semester Project/notebooks/Week6/submissions/Scale_RF_KNN_Ridge.csv")
...
test_predict_RF_KNN_Ridge = model.predict(test_data_RF_KNN)

RF_KNN_Ridge=submission_file_template.copy()
RF_KNN_Ridge.target=test_predict_RF_KNN_Ridge

RF_KNN_Ridge=RF_KNN_Ridge.set_index('ID')
RF_KNN_Ridge.to_csv("/content/drive/MyDrive/Master Semester Project/notebooks/Week6/submissions/Scale_tune_Ridge_v1.csv")
...
RF_KNN_Ridge=RF_KNN_Ridge.set_index('ID')
RF_KNN_Ridge.to_csv("/content/drive/MyDrive/Master Semester Project/notebooks/Week6/submissions/Scale_tune_Ridge_v2.csv")
